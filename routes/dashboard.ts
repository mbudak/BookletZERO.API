...
router.get('/category', async (req, res) => {
    ...
    res.render('pages/dashboard/category', { breadcrumbs : [ { cid: null, name: "Categories" }], categories : categories });
})
...
router.get('/category/:id', async (req, res) => {    
    ...
    res.render('pages/dashboard/category', { breadcrumbs: breadcrumbs, categories : categories });
})
